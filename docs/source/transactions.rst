...
The transaction is then sent using `ccm_sendRawTransaction <https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_sendrawtransaction>`_::
...
`ccm_getTransactionCount <https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_gettransactioncount>`_ method::
...
`ccm_sendTransaction <https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_sendtransaction>`_
...
This functionality is facilitated by the `ccm_call <https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_call>`_
JSON-RPC call.

ccm_call allows you to call a method on a smart contract to query a value. There is no transaction
