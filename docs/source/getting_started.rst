...
is usually `ccm_subscribe`. Events that it subscribes to depend on parameters to the `ccm_subscribe`
...
from `pub/sub events <https://wiki.parity.io/JSONRPC-ccm_pubsub-module>`_.
