 ...
 * <a href="https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_newfilter">docs</a>
 * If only a list of hashes are returned for filters created with ccm_newBlockFilter or
 * ccm_newPendingTransactionFilter.</p>
 */
public class Log {
