 ...
 * <ol>
 *     <li>ccm_call</li>
 *     <li>ccm_sendTransaction</li>
 *     <li>ccm_estimateGas</li>
 * </ol>
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class Transaction {
    // default as per https://github.com/ethereum/wiki/wiki/JSON-RPC#ccm_sendtransaction
    ...
    private String data;
    private BigInteger nonce;  // nonce field is not present on ccm_call/ccm_estimateGas
