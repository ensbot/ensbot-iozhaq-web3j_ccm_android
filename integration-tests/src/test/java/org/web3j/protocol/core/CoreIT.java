...
public class CoreIT {
    ...
    @Ignore  // The method ccm_compileLLL does not exist/is not available
    @Test
    ...
    @Ignore  // The method ccm_compileSerpent does not exist/is not available
    @Test
    ...
    public void testFiltersByFilterId() throws Exception {
        ...
        // ccm_getFilterChanges - nothing will have changed in this interval
